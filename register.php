          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form class="form-validate" action="register_handler.php" method="post">

                  <div class="form-group">
                      <input id="register-fname" type="text" name="fname" required data-msg="Please enter your first name" class="input-material">
                      <label for="register-fname" class="label-material">Fisrt Name</label>
                    </div>

                    <div class="form-group">
                      <input id="register-lname" type="text" name="lname" required data-msg="Please enter your last name" class="input-material">
                    ...
                    <div class="form-group terms-conditions">
                      <input id="register-agree" name="registerAgree" checked type="checkbox" required value="1" data-msg="Your agreement is required" class="checkbox-template">
                  ...
                  </form><small>Already have an account? </small><a href="/qrcode/" class="signup">Login</a>
                </div>
              </div>
            </div>
          </div>
